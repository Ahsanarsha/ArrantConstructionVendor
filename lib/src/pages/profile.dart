import 'package:arrant_construction_vendor/src/controllers/user_controller.dart';
import 'package:arrant_construction_vendor/src/dialogs/confirmation_dialog.dart';
import 'package:arrant_construction_vendor/src/dialogs/edit_profile_dialog.dart';
import 'package:arrant_construction_vendor/src/models/user.dart';
import 'package:arrant_construction_vendor/src/widgets/user_data.dart';
    ...
    return Obx(() {
      return Column(
        ...
        children: [
          ...
          _userAttributeListTile(
            icon: Icons.work,
            text: user_repo.currentUser.value.pastExperience!,
          ),
        ],
      );
    });
